...
// menentukan posisi baris awal
#define awal_baris 23

// menentukan posisi baris akhir
#define akhir_baris 3

// karena gerakan dari bawah ke atas
// maka baris awal lebih besar dari baris akhir
...
for (huruf=0;huruf<panjang_kalimat;huruf++)
{
 ...
 for (baris=awal_baris;baris>=akhir_baris;baris--)
 {
