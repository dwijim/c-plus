...
int main(){
  ...
  // nodelay - enable or disable block during read
   ...
   mvprintw(baris,kolom," aku ");
            short int baris_peluru;

   mvprintw(23,1,"Tombol: Bergerak: Panah kiri/kanan, Tembak: Panah atas");
          ...
          if (tombol == KEY_ENTER)
                { 
                  ...
                  // dapat dituliskan di sini
                    mvprintw(baris_peluru,kolom,"bingung");
                  getch();
                  for(baris_peluru=baris;baris_peluru>=5;baris_peluru--)
                  {
                ...
                { 
                  ...
                  for(baris_peluru=baris;baris_peluru>=5;baris_peluru--)
                  {
                    mvprintw(baris_peluru-1,kolom+2,"*");
                     sleep(1);refresh();
                    mvprintw(baris_peluru-1,kolom+2," ");
